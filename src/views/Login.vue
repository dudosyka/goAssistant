        ...
        <div class="row">
          <div>
            <section class="form_login" v-show="!lever">
              <input v-model='email' type="mail" class="input" placeholder="Email" :invalid="valid.email">
              <input v-model='password' type="text" class="input" placeholder="Password" style="margin:0;" :invalid="valid.pass">
            </section>
